...
class SalonsControllerTest < ActionController::TestCase
  ...
  test "should create salon" do
    assert_difference('Salon.count') do
      post :create, salon: { address: @salon.address, email: @salon.email, phone_number: @salon.phone_number, salon_name: @salon.salon_name }
    end
  ...
  test "should update salon" do
    put :update, id: @salon, salon: { address: @salon.address, email: @salon.email, phone_number: @salon.phone_number, salon_name: @salon.salon_name }
    assert_redirected_to salon_path(assigns(:salon))
  end
